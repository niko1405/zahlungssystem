...
class InvoiceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateInvoice = channel.unary_unary(
                ...
                request_serializer=invoice__pb2.InvoiceRequest.SerializeToString,
...
def add_InvoiceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateInvoice': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=invoice__pb2.InvoiceRequest.FromString,
    ...
    server.add_registered_method_handlers('InvoiceService', rpc_method_handlers)
...
class InvoiceService(object):
    ...
    def CreateInvoice(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/InvoiceService/CreateInvoice',
            invoice__pb2.InvoiceRequest.SerializeToString,
